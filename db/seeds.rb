...
Movie.create(title: 'Street Trash', 
			 filename: 'https://www.youtube.com/watch?v=4sLldf6IdYI', 
			 year: Date.parse('September 16, 1987'),
			 cover_image: 'street-trash.jpg')
...
Movie.create(title: 'Demons', 
			 filename: 'https://www.youtube.com/watch?v=kWamJZ47EpA', 
			 year: Date.parse('May 30, 1986'),
			 cover_image: 'demons.jpg')

Movie.create(title: 'Demons 2', 
			 filename: 'https://www.youtube.com/watch?v=nvFUF7ceags', 
			 year: Date.parse('February 13, 1987'),
			 cover_image: 'demons-2.jpg')
...
Movie.create(title: 'Hellraiser', 
			 filename: 'https://www.youtube.com/watch?v=0qTOSgV38WM', 
			 year: Date.parse('September 18, 1987'),
			 cover_image: 'hellraiser.png')

Movie.create(title: 'Hellbound: Hellraiser II', 
			 filename: 'https://www.youtube.com/watch?v=pZNUXuji0mU', 
			 year: Date.parse('December 23, 1988'),
			 cover_image: 'hellraiser2.jpg')
...
Movie.create(title: 'Pieces', 
			 filename: 'https://www.youtube.com/watch?v=xYE6kHdxQCI', 
			 year: Date.parse('September 23, 1983'),
			 cover_image: 'pieces.png')
...
Movie.create(title: 'Christmas Evil', 
			 filename: 'https://www.youtube.com/watch?v=NTBmdVbAknY', 
			 year: Date.parse('November 1, 1980'),
...
Movie.create(title: 'House III: The Horror Show', 
			 filename: 'https://www.youtube.com/watch?v=GZfb4OKWmPs', 
			 year: Date.parse('April 28, 1989'),
			 cover_image: 'house-3.jpg')
...
Movie.create(title: 'Without Warning', 
			 filename: 'https://www.youtube.com/watch?v=36tUcv6al9s', 
...
Movie.create(title: 'Xtro', 
			 ...
			 cover_image: 'xtro.jpg')

Movie.create(title: 'Night of the Comet', 
			 filename: 'https://www.youtube.com/watch?v=IRrniG0RWsA', 
			 year: Date.parse('November 16, 1984'),
			 cover_image: 'night-of-the-comet.jpg')

Movie.create(title: 'Spookies', 
			 filename: 'https://www.youtube.com/watch?v=rKWjjhYEdRM', 
			 year: Date.parse('May 14, 1986'),
			 cover_image: 'spookies.jpg')

Movie.create(title: 'Reform School Girls', 
